...
#     _id = models.IntegerField()  #论文相关度，数字越小越相关
#     title = models.CharField('标题', max_length=200) #论文标题
#     authors = models.CharField('作者', max_length=200) #论文作者
#     abstract = models.TextField('摘要')
#     publicationOrg = models.CharField('出版机构', max_length=100)
#
...
class Post(models.Model):
    ...
    # 新增views字段记录阅读量，PositiveIntergerField
